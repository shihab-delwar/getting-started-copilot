...
activities = {
    ...
    "Basketball Club": {
        "description": "Practice shooting, dribbling, and teamwork for basketball games",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "isabella@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore drawing, painting, and crafts in a relaxed studio setting",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["mia@mergington.edu", "ethan@mergington.edu"]
    },
    "Drama Club": {
        "description": "Develop acting skills and put on school plays and performances",
